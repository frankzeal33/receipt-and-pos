...
const page = () => {
  ...
  const getSalesReport = async () => {
      ...
      const response = await axiosClient.get(`/sales/sales-chart`)
      ...
      <Card className="py-0">
        <CardHeader className="flex flex-col items-stretch border-b !p-0 sm:flex-row">
          <div className="flex flex-1 flex-col justify-center gap-1 px-6 pt-4 pb-3 sm:!py-0">
            ...
            <CardDescription>
              Showing total sales filtered by month
            </CardDescription>
          </div>

          {/* ✅ Month Dropdown added here */}
        ...
        <CardContent className="px-2 sm:p-6">
          ...
          >
            ...
            >
              ...
              />
              <Bar dataKey={activeChart} fill={"#008000"} />
            </BarChart>
          </ChartContainer>
        </CardContent>
      </Card>
