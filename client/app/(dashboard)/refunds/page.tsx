...
import RefundMore from './_components/RefundMore'
  ...
  const [count, setCount] = useState(0)
   const tableList = new Array(8).fill(null)
    ...
    const getOrders = async () => {
        ...
        const response = await axiosClient.get(`/sales/get-sales?status=REFUNDED&page=${page}&page_size=${pageSize}`)
    ...
    <div className='my-container'>
        ...
        <div className='bg-light p-3 rounded-xl border w-full'>
            <div className='flex items-center gap-2 mb-4'>
                <p className="text-lg font-medium leading-none">Total Refund ({count || 0})</p>
            </div>
                ...
                <div className="w-full min-h-[58vh] flex flex-col items-center justify-between overflow-x-auto">
                                ...
                                <TableBody>
                                    ...
                                    <TableRow key={order?.id}>
                                        ...
                                        <TableCell className='capitalize bg-muted/30'>
                                            <RefundMore order={order} getOrders={getOrders}/>
                                        </TableCell>
                                    </TableRow>
                                    ))}
                                </TableBody>
                    ...
                    {orders.length === 0 &&
                        <div className='flex flex-col items-center justify-center min-h-[50vh] w-full'>
                            <NotFound imageStyle='size-14' title='No refunds found' desc='No refund have been added yet'/>
                        </div>
                    }
