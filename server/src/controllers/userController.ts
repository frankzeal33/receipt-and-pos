...
import { loginInput, RegisterInput, updateInput, verifyRegInput, verifyRegLinkInput } from "../types/zodtypes/authType.ts";
...
const verifyRegOtp = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const cachedOtp = await getCache<string>(`otp_${email}`);
...
const verifyRegLink = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const cached = await getCache<string>(`verify_${token}`);
...
const loginUser = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const { email, password } = (req.validated as loginInput).body;
