...
import { addCustomerSchema, correctSaleSchema, deleteCustomerSchema, editCustomerSchema, getSaleByIdSchema, makeSaleSchema } from "../validations/Sale.js";
import { addCustomer, correctSale, deleteCustomer, editCustomer, getCustomers, getIsRead, getNotifications, getProducts, getSaleById, getSales, getSalesChart, makeSale, refundSale } from "../controllers/salesController.js";
import { paginationSchema } from "../validations/Staff.js";
