...
import { registerUser, loginUser, logoutUser, getUserProfile, updateUserProfile, verifyRegOtp, verifyRegLink, forgotPassword, verifyForgotPasswordOtp, verifyForgotPasswordLink, resendRegVerificationEmail, resetPassword } from "../controllers/userController.js";
import { validateMiddleware } from "../middlewares/validateMiddleware.js";
import { forgotPasswordSchema, loginSchema, registerSchema, resendRegVerificationSchema, resetPasswordSchema, updateSchema, verifyRegLinkSchema, verifyRegSchema } from "../validations/Auth.js";
import { rateLimitByField } from "../middlewares/rateLimiterMiddleware.js";
import { protectAll, protectCEO } from "../middlewares/authMiddleware.js";
